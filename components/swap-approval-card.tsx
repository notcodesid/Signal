...
export function SwapApprovalCard({
  ...
  return (
    <div className="my-2 w-full rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm">
      <div className="mb-3 flex items-center justify-between">
        <span className="font-semibold text-blue-900">Swap proposal</span>
        <span className="rounded-full bg-blue-100 px-2 py-0.5 text-[10px] uppercase tracking-wider text-blue-700">
          {preview.cluster}
        </span>
      </div>
      ...
      {state === "rejected" && (
        <div className="mt-3 text-xs text-gray-500">Swap rejected.</div>
      )}
